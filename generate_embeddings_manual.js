...
console.log("1. Call the OpenAI API to create embeddings for each profile text");
console.log("2. Insert the embeddings into the expert_embeddings table");
console.log("3. This should be done via the generate_expert_embeddings edge function");