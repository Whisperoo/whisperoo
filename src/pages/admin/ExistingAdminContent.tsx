...
const ExistingAdminContent: React.FC = () => {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-sm font-bold text-gray-800">AI Compliance Training Pipeline</h3>
            <p className="text-xs text-gray-500">Review and curate AI compliance training data</p>
          </div>
        </div>
      </div>
                  ...
                  {isExpanded && (
                    <div className="border-t border-gray-100 px-5 py-4 space-y-4 bg-gray-50/50">
                      ...
                      <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-gray-200">
                        ...
                        <span className="text-xs text-gray-400 flex items-center gap-1 mt-2 sm:mt-0">
...
export default ExistingAdminContent;
