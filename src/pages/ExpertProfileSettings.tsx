...
export const ExpertProfileSettings: React.FC = () => {
  ...
  if (!profile || profile.account_type !== "expert") {
    return (
      <div className="min-h-screen bg-gray-50 px-4 py-4 md:p-6">
        ...
        <CardContent className="p-4 md:p-8 ">
          ...
          >
            <TabsList className="grid grid-cols-4">
              ...
              <TabsTrigger value="personal" className="gap-2 flex-shrink-0">
                <User className="h-4 w-4" />
                Personal
              </TabsTrigger>
              <TabsTrigger value="consultation" className="gap-2 flex-shrink-0">
            ...
            <TabsContent value="personal" className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Manage your personal profile, family information, and
                  preferences
                </p>
            ...
            <TabsContent value="verification" className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Upload verification documents and manage your credential
                  status
                </p>
