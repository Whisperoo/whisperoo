...
export const UserResources: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="bg-white w-full max-w-full overflow-x-hidden rounded-xl shadow-card p-6 mb-6 border border-gray-200">
      ...
      <div className="bg-white rounded-xl shadow-card p-6 mb-6 border border-gray-200">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 mb-6 max-w-sm mx-auto">
            Start building your parenting resource library with expert-created
            content tailored to your family's needs.
          </p>
          <button
            onClick={() => navigate("/products")}
    ...
    <div className="bg-white rounded-xl shadow-card p-6 mb-6 border border-gray-200 hover:shadow-elevated transition-shadow duration-300">
      ...
      <div className="space-y-4 flex flex-col">
        {displayPurchases.map((purchase: any, index: number) => (
          <div
            key={purchase.id}
            className="group bg-gray-50 hover:bg-white border border-gray-100 hover:border-brand-primary hover:shadow-card rounded-lg p-4 cursor-pointer transition-all duration-300 transform hover:scale-[1.01] w-full box-border overflow-hidden" // ← ADD THESE
          ...
          >
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-3 flex-1 min-w-0 overflow-hidden">
                {" "}
                {/* ← ADD flex-1 min-w-0 overflow-hidden */}
