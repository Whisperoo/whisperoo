    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <ChildrenManager />
          <p className="text-sm text-gray-600 mt-2">
            Your family information helps you provide more personalized expert advice
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">Areas you're personally interested in or experienced with</p>
        </CardHeader>
        <CardContent>
          <div className="flex flex-wrap gap-2">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">
            This helps families understand your personal perspective alongside your professional expertise
          </p>
        </CardContent>
      </Card>
